...
<h2>입금전 주문취소</h2>
		              ...
		              <tr>
						...
						<td>
		             	...
		             	<tr>
		             		<th>취소유형</th>
		             		<td>
		             			<input type="radio" name="all">전체 
		             			<input type="radio" name="all">고객취소 
		             			<input type="radio" name="all">관리자 취소 
		             			<input type="radio" name="all">자동취소 
		             		</td>
		             	</tr>
		              <tr>
		             	<th>결제 수단</th>
   ...
   <div class="container">
   <ul class="tabs">
      <li class="tab-link current" data-tab="tab-1">전체취소</li>
      <li class="tab-link" data-tab="tab-2">부분취소</li>
   </ul>

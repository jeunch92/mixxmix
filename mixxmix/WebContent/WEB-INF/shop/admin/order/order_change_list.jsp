...
<h2>교환관리</h2>
   ...
   <div class="container">
   <ul class="tabs">
      <li class="tab-link current" data-tab="tab-1">교환신청</li>
      <li class="tab-link" data-tab="tab-2">반송대기</li>
      <li class="tab-link" data-tab="tab-3">재주문대기</li>
      <li class="tab-link" data-tab="tab-4">교환완료</li>
   </ul>
            ...
            <tr align="right">
            	<td colspan="7">
            		...
            		<input type="button" name="restore" value="복구하기">
            		  <input type="button" name="recive" value="접수하기">
            	</td>
            </tr>
            </table>                                                                 
			</table><!-- 두번째 테이블 -->

...
<div align="center">
		...
		<tr>
			...
			<td align="left">
				<select name="search">
         		...
         		<input type="hidden" name="searchString" value="searchString1"> -->
			</td>
		</tr>
	</table>
	<hr color="#D8D8D8" width="100%">
	<input type="submit" value="검색">
	<a href="member_find.do"><h3>검색</h3></a>
	...
	<table border=1 cellpadding="5" bordercolor="#D8D8D8" width="100%">
		...
		<c:if test="${find==null || find.size()==0}">
			<tr>
		...
		<c:forEach var="dto" items="${find}">
			<tr>
				...
				<td>${dto.m_point}</td>
				<td>${dto.m_mem_ok}</td>
				<td><input type="button" value="삭제" onclick="window.location='member_delete.do?num=${dto.m_num}'"></td>
			</tr>
		</c:forEach>
	</table>
	<br>
